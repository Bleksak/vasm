...
struct EncodedInstruction aad(struct Operand* operand1, struct Operand* operand2, struct Operand* operand3, struct Operand* operand4, struct x86_instruction_arguments* args)
{
    if(operand1->exists)
    {
